...
void Wheel::Update()
{
	...
	if (leftDamage < 5) leftDamageLevel = 0;
	if (leftDamage > 5 && leftDamage < 15) leftDamageLevel = 1;
	if (leftDamage > 15 && leftDamage < 25) leftDamageLevel = 2;
	if (leftDamage >= 25) leftDamageLevel = 3;

	if (rightDamage < 5) rightDamageLevel = 0;
	if (rightDamage > 5 && rightDamage < 15) rightDamageLevel = 1;
	if (rightDamage > 15 && rightDamage < 25) rightDamageLevel = 2;
	if (rightDamage >= 25) rightDamageLevel = 3;
