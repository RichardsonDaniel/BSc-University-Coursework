...
// result contains all of the reviews that have PS Vita as the platform reviewed on
 $result = mysql_query("SELECT * FROM reviews WHERE psVita='PS Vita'");
   echo "<h1> PS Vita Review</h1>";
